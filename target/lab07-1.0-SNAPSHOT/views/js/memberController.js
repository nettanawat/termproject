...
memberMainController.controller('listMemberController', ['$scope', '$http', '$rootScope','memberService','$route','totalCalService',
    function ($scope, $http, $rootScope,memberService,$route,totalCalService) {
        ...
        $http.get("/lasttwomember").success(function (data) {
            $scope.lastTwoDatas = data;
        });
...
memberMainController.controller('editProductController', ['$scope', '$http', '$routeParams', '$location', '$rootScope','productService',
